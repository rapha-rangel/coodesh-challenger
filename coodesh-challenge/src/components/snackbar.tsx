...
export default function Snackbar ({title, content}:SnackbarProps){
  ...
  return(
    <div className={`fixed left-[50%] -translate-x-[50%] bg-teal-100 border-t-4 border-teal-500 rounded-lg text-teal-900 px-4 py-1 shadow-md transition-all duration-500 z-30
